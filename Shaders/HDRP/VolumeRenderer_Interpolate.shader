Shader "Custom/HDRP/VolumeRenderer_Interpolate"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // helper, which HDRP doesn't provide; it already accounts for
                // HDRP's dynamic resolution scaling the same way that one did
                // for URP's Render Scale.
                ...
                if (hasOpaqueSurface)
                {
                    ...
                    // scenePosWS is already in the same (camera-relative or
                    // absolute) space as rayOriginOS above, since both
                    // ultimately derive from UNITY_MATRIX_I_VP /
